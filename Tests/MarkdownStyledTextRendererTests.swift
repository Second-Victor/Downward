...
final class MarkdownStyledTextRendererTests: XCTestCase {
    ...
    func testRendererUsesResolvedThemeRolesForMarkdownStyling() {
        ...
        let strikethroughMarkerRange = nsString.range(of: "~~")
        ...
        XCTAssertEqual(rendered.attribute(.foregroundColor, at: headingMarkerRange.location, effectiveRange: nil) as? UIColor, customTheme.headingText)
        ...
        XCTAssertEqual(rendered.attribute(.foregroundColor, at: strikethroughMarkerRange.location, effectiveRange: nil) as? UIColor, customTheme.strikethroughText)
